...
class KoBARTConditionalGeneration(Base):
    ...
    def forward(self, inputs):
        ...
        inputs['decoder_input_ids'] = inputs['decoder_input_ids'].long()
        inputs['labels'] = inputs['labels'].long()

        print('-----------------------')
        print(inputs['input_ids'].dtype)
        print(inputs['decoder_input_ids'].dtype)
...
if __name__ == '__main__':
    ...
    python
    train.py - -gradient_clip_val
    1.0 - -max_epochs
    1 - -default_root_dir. / NLP / BART - -gpus
    0 - -batch_size
    4 - -num_workers
    12 - -checkpoint_path. / NLP / BART - -train_file. / data / train.tsv - -test_file. / data / test.tsv